...
class makeRecoNtuple {
 ...
 private :
    ...
    //added by Dipak
    //std::vector<int>     _nTau;
       UInt_t              _nTau;
    std::vector<float>   _tauPt1;
    std::vector<float>   _tauEta1;
    std::vector<float>   _tauPhi1;
    std::vector<float>   _tauPt2;
    std::vector<float>   _tauEta2;
    std::vector<float>   _tauPhi2;
    ...
    std::vector<float>   _DitauMass;
    std::vector<int>   _DitauCharge;
    std::vector<float>   _DitauSumPt;
    ...
    bool  dileptonsample;
    //added by Dipak
    bool _pass_trigger_tau;
    bool _passPresel_Tau;
...
void makeRecoNtuple::InitBranches(){
    ...
    //added by Dipak
      ...
      outputTree->Branch("DitauMass"                  , &_DitauMass                               );
      outputTree->Branch("DitauSumPt"                  , &_DitauSumPt                               );
      outputTree->Branch("DitauCharge"                  , &_DitauCharge                               );


      outputTree->Branch("tau_Pt"                       , &_tauPt                      );
      outputTree->Branch("tau_Phi"                      , &_tauPhi                     );
      outputTree->Branch("tau_Eta"                      , &_tauEta                     );
      ...
      //  outputTree->Branch("DitauDelR"                  , &_DitauDelR                   );
     
    outputTree->Branch("nTau"                        , &_nTau                       );
    ...
    //added by Dipak
    outputTree->Branch("passPresel_Tau"                  , &_passPresel_Tau     );
...
void makeRecoNtuple::InitVariables()
{
    ...
    //added by dipak
    _passPresel_Tau =false;
    _pass_trigger_tau = false;
    _nTau    = -9999;
