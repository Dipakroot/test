...
EventTree::EventTree(int nFiles, bool xRootDAccess, string year, char** fileNames, bool isMC){
    ...
    //chain->SetBranchStatus("Tau_chargedIso",1);
    ...
    //chain->SetBranchStatus("Tau_jetIdx",1);
	...
	//Added by Dipak for Taus
	chain->SetBranchStatus("HLT_DoubleMediumChargedIsoPFTauHPS35_*",1);
        chain->SetBranchAddress("HLT_DoubleMediumChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg",&HLT_DoubleMediumChargedIsoPFTauHPS35_TightID_);
        chain->SetBranchAddress("HLT_DoubleMediumChargedIsoPFTauHPS35_Trk1_eta2p1_Reg",&HLT_DoubleMediumChargedIsoPFTauHPS35_);
