...
void EventPick::process_event(EventTree* tree){
	...
	//Added by Dipak
	pass_trigger_tau = (tree->HLT_DoubleMediumChargedIsoPFTauHPS35_TightID_ || tree->HLT_DoubleMediumChargedIsoPFTauHPS35_);
    }
    ...
    // Edited by Dipak 
    //    passSkim = (Pass_trigger_ele || Pass_trigger_mu || pass_trigger_tau) && filters;
    passSkim = (pass_trigger_tau) && filters;
